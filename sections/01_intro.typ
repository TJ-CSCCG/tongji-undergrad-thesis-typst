...
在本节（@introduction）中，我们将讨论文档中常用的各种标题级别和字体样式。在文章中，标题是非常重要的组成部分之一，它可以帮助读者更好地理解文章的结构和内容。
...
- #{
  set text(font: 宋体)
  [使用命令 #raw("set text(font: 宋体)", lang:"typ")。]
}
- #{
  set text(font: 黑体)
  [使用命令 #raw("set text(font: 黑体)", lang:"typ")。]
}
- #{
  set text(font: 仿宋)
  [使用命令 #raw("set text(font: 仿宋)", lang:"typ")。]
}
- #{
  set text(font: 楷体)
  [使用命令 #raw("set text(font: 楷体)", lang:"typ")。]
}
